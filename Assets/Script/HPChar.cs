...
public class HPChar : MonoBehaviour {
	...
	void Awake () {
		...
		posstamina = new Vector3(-4.63f,5.2f,0f);
	...
	void Start () {
        ...
        //ukurstamina = GameMgr.StaminaChar;
	}
	
	// Update is called once per frame
	void Update () {
        //if (ukuran.x >= 7.0 && GameMgr.StaminaChar.x != 0.0) //initial HP
        //{
        //    ukuran.x = GameMgr.StaminaChar.x;
        //}
